import React, { useEffect, useState, useRef } from 'react'; // Dodano useRef
                ...
                <Paper elevation={3} sx={{ ...LoginFormWrapper(), marginTop: '8px' }}>
                    <Box sx={{ ...LoginFormScroll(), ...LoginFormScrollContent(), overflowY: 'auto' }}>
                        ...
                        <Box sx={LoginFormContainer()}>
                            ...
                            {status === 'success' && (
                                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', my: 2 }}>
                                    <CheckCircle2 size={50} color={colors.green} style={{ marginBottom: '12px' }} />
                                    <Typography variant="h5" sx={{ ...LoginTitle(), color: colors.green, marginBottom: '8px' }}>
                                        Account Activated!
                                    </Typography>
                                    <Alert severity="success" sx={{ width: '100%', borderRadius: '8px', marginBottom: '20px' }}>
                                        {message}
                                    </Alert>
                                    <Button
                                        variant="contained"
                            ...
                            {status === 'error' && (
                                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', my: 2 }}>
                                    ...
                                    <Typography variant="h5" sx={{ ...LoginTitle(), color: colors.red, marginBottom: '8px' }}>
                                        Verification Failed
                                    </Typography>
                                    <Alert severity="error" sx={{ width: '100%', borderRadius: '8px', marginBottom: '20px' }}>
                                        {message}
                                    </Alert>
                                    <Button
                                        variant="contained"
