                            ...
                            <Table sx={{minWidth: 650}}>
                                <TableHead sx={{backgroundColor: "rgba(0,0,0,0.02)"}}>
                                    <TableRow>
                                        ...
                                        <TableCell sx={{fontWeight: "bold", textAlign: "center"}}>Single
                                            Price</TableCell>
                                        ...
                                        <TableRow key={ticket.id} sx={{
                                            ...
                                            <TableCell>
                                                <Typography variant="body2"
                                                            sx={{fontWeight: "bold"}}>{ticket.movieTitle}</Typography>
                                                <Typography variant="caption"
                                                            color="textSecondary">{ticket.hallName}</Typography>
                                            </TableCell>
